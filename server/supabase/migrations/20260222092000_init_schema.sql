...
create index if not exists idx_payment_transactions_charge_id on public.payment_transactions(charge_id);
create index if not exists idx_payment_transactions_customer on public.payment_transactions(customer_id, customer_type);
